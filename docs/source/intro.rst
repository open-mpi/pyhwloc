...
.. note::
   ...
   Currently, the Python interface is built upon the latest hwloc (3.0), which has an
   updated and incompatible XML schema. As a result, one cannot load xml files from older
   versions of hwloc with pyhwloc.
